...
--
-- Name: account_relation_type; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE account_relation_type AS ENUM (
    'block',
    'mute'
);
...
--
-- Name: account_relations; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE account_relations (
    ...
    type account_relation_type NOT NULL
);
...
CREATE TABLE blocks (
    ...
    type account_relation_type,
    CONSTRAINT check_blocks_on_type CHECK ((type = 'block'::account_relation_type))
)
INHERITS (account_relations);
...
CREATE TABLE mutes (
    ...
    updated_at timestamp without time zone,
    type account_relation_type,
    CONSTRAINT check_mutes_on_type CHECK ((type = 'mute'::account_relation_type))
)
INHERITS (account_relations);
